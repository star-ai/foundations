...
class TestScreenSelectAndMoveBrain(unittest.TestCase):
  ...
  def test_call(self):
    ...
    # print(p)
    self.assertEqual((2, 84, 84, 1), p.shape)
  ...
  def test_train_policy(self):
    ...
    self.assertAlmostEqual(1.0, y_hat_trained.numpy()[0][0][3][0], 1)
  ...
  def test_train_both(self):
    ...
    # print(p[:, :1, :, :])
    # print(v)
    self.assertAlmostEqual(1.0, p.numpy()[0][0][3][0], 1)
